...
__train_filepath = '.\Google_Stocks_Train.csv'
__test_filepath = '.\Google_Stocks_Test.csv'
...
def plot_prediction(y_test, y_predicted, test_label, prediction_label,title="Stock Price Prediction"):
    set_plot_style()
